...
class Review(TypedDict):
    keyThemes: Annotated[list[str], "List all the key themes that are discussed in the review"]
    pros: Annotated[list[str], "List all the pros mentioned in the review, you can skip them if pros are not available thery are optional data"]
    cons: Annotated[list[str], "List all the cons mentioned in the review, you can skip them if cons are not available thery are optional data"]
