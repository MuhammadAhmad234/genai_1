...
| **Chatbot**        | LangChain messaging system, building a CLI chatbot with memory |
...
### 5. Chatbot — CLI Chatbot with Memory

> **Files:** `chatbot/`

Build a conversational AI chatbot that remembers context:
